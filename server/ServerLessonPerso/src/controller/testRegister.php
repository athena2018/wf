...
// 2 needed for the request method = POST
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    
    
    
// 3 store the html input as variable for the post request    
 ...
 // 5 use conditions for the different inputs of the formular as success or errors
...
<!--  4 display by htmlentites() the inputs for the user -->			
